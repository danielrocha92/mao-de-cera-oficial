    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.content}>
                <p>A sua privacidade é importante para nós. É política do Mão de Cera Oficial respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Mão de Cera Oficial, e outros sites que possuímos e operamos.</p>
